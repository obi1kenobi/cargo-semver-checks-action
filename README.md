...
| `rust-toolchain`     | Rust toolchain name to use, e.g. `stable`, `nightly` or `1.32.0`. | `stable` |
| `rust-override`      | If Rust is already installed, whether to override it with version specified in `rust-toolchain`. | `false` |
